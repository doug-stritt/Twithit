...
//static SA_OAuthTwitterEngine *sharedInstance=nil;
...
/*+(SA_OAuthTwitterEngine*)sharedTwitterEngine: (NSObject *) delegate
{
	@synchronized(self)
	{
		if(sharedInstance==nil)
		{
			[[[SA_OAuthTwitterEngine alloc] initOAuthWithDelegate: delegate] autorelease];
		}
	}
